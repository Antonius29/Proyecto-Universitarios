            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        ...
                        <a href="#" onclick="abrirConfirmModal('index.php?modulo=clientes&accion=eliminar&id=${cliente.id}', '¿Está seguro de que desea eliminar este cliente?')" class="btn btn-sm btn-danger">
