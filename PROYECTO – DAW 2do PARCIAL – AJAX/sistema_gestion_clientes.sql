...
('PED0001', 1, 2, '2025-01-10', 'completado', 'transferencia', 'Av. Principal 123, Guayaquil', 1250.00, 'Pedido completado y entregado exitosamente'),
('PED0002', 2, 3, '2025-01-12', 'proceso', 'tarjeta', 'Calle 10 de Agosto, Quito', 925.00, 'En proceso de empaque y preparación'),
('PED0003', 3, 2, '2025-01-15', 'completado', 'efectivo', 'Malecon 2000, Guayaquil', 1610.00, 'Entregado al almacén del cliente'),
('PED0004', 4, 4, '2025-01-16', 'pendiente', 'transferencia', 'Av. Amazonas, Quito', 475.00, 'Pendiente confirmación de pago del cliente'),
...
(5, 2, 2, 180.00, 360.00, 'Monitores para renovación de equipos');
