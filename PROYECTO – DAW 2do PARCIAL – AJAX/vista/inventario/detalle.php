        ...
        <div class="card">
            <div class="page-header">
                ...
                <div class="action-buttons">
                    ...
                    <a href="#" onclick="abrirConfirmModal('index.php?modulo=inventario&accion=eliminar&id=<?php echo $producto['id']; ?>', '¿Está seguro de que desea eliminar este producto?')" class="btn btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" onclick="abrirConfirmModal('index.php?modulo=inventario&accion=movimiento_eliminar&id=<?php echo $movimiento['id']; ?>&producto_id=<?php echo $producto['id']; ?>', '¿Desea eliminar este movimiento de inventario?')" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
