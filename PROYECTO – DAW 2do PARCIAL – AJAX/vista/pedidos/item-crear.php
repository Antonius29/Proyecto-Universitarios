        ...
        <div class="card">
            ...
            <form action="index.php?modulo=pedidos&accion=guardar_item" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="cantidad" name="cantidad" required min="1" value="1" onchange="calcularSubtotal()">
                </div>

                <div class="form-group">
                    <label for="precio_unitario"><i class="bi bi-currency-dollar"></i> Precio Unitario <span class="required">*</span></label>
                    <input type="number" id="precio_unitario" name="precio_unitario" required step="0.01" min="0" value="0.00" onchange="calcularSubtotal()">
                </div>
