...
class Usuario {
    ...
    private $bloqueado;      // Estado de bloqueo del usuario
     ...
     * @param bool $bloqueado - Estado de bloqueo del usuario
     */
    public function __construct($id = null, $nombre = '', $email = '', $password = '', $rol_id = null, $activo = true, $bloqueado = false) {
        $this->id = $id;
        $this->nombre = $nombre;
        $this->email = $email;
