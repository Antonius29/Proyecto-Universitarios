        ...
        <main class="main-content">
            ...
            <div class="content">
                ...
                <div class="stats-grid">
                    ...
                    <!-- Tarjeta 2: Total de Proyectos (color verde) -->
                    <div class="stat-card stat-green">
                        <h3>Proyectos</h3>
                        <p class="stat-number" id="totalProyectos">0</p>
                        <a href="oportunidades.php">Ver todos</a>
                    </div>
                    
                    <!-- Tarjeta 3: Total de Tareas (color rojo) -->
                    <div class="stat-card stat-red">
                        <h3>Tareas</h3>
                        <p class="stat-number" id="totalTareas">0</p>
    ...
    <script>
        ...
        async function cargarEstadisticas() {
            try {
                ...
                document.getElementById('totalTareas').textContent = tareas.length || 0;
