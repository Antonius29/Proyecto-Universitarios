        ...
        <div class="card">
            <div class="page-header">
                ...
                <div class="action-buttons">
                    ...
                    <a href="#" onclick="abrirConfirmModal('index.php?modulo=pedidos&accion=eliminar&id=<?php echo $pedido['id']; ?>', '¿Está seguro de que desea eliminar este pedido? Esta acción no se puede deshacer.')" class="btn btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                ...
                <table>
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" onclick="abrirConfirmModal('index.php?modulo=pedidos&accion=eliminar_item&id=<?php echo $item['id']; ?>&pedido_id=<?php echo $pedido['id']; ?>', '¿Desea eliminar este item del pedido?')" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        ...
                        <tr style="background-color: var(--color-gray-light); font-weight: 700;">
                            ...
                            <td style="color: var(--color-primary); font-size: 18px;">$<?php echo number_format($pedido['total'], 2); ?></td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
