            ...
            <div class="page-header">
                ...
                <div class="action-buttons">
                    ...
                    <?php if ($usuario['id'] != $_SESSION['usuario_id']): ?>
                        <a href="#" onclick="abrirConfirmModal('index.php?modulo=usuarios&accion=eliminar&id=<?php echo $usuario['id']; ?>', '¿Está seguro de que desea eliminar este usuario?')" class="btn btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                    <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" onclick="abrirConfirmModal('index.php?modulo=usuarios&accion=actividad_eliminar&id=<?php echo $actividad['id']; ?>&usuario_id=<?php echo $usuario['id']; ?>', '¿Desea eliminar esta actividad?')" class="btn btn-sm btn-danger"><i class="bi bi-trash"></i> Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
