...
<head>
    ...
    <title>Oportunidades - Sistema de Gestión</title>
    ...
    <div class="dashboard">
        <nav class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="oportunidades.php" class="active">Oportunidades</a></li>
        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="toolbar">
                    <button class="btn btn-primary" onclick="mostrarFormulario()">Nueva Oportunidad</button>
                </div>

                <div id="formularioOportunidad" class="form-container" style="display:none;">
                    <h3>Agregar Oportunidad</h3>
                    <form id="formOportunidad">
                        <input type="hidden" id="oportunidadId" name="id">
